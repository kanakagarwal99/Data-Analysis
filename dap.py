...
Original file is located at
    https://colab.research.google.com/drive/1KwDp2Wb1F6LxxuwrdHVy7E-yUdvtMW9t
"""
...
#Loading a Text file
a=pd.read_csv("/content/youtube_links_test.txt",sep=" ")
print(a)
print(a.loc[1])
print(a.loc[2:3])
...
plt.subplot(2,1,2)
plt.plot(years,profit_a,color='hotpink',linewidth='3',label='CompanyA',marker='*',ms='10',mec='b')
plt.subplot(2,1,1)
plt.plot(years,profit_b,color='black',linestyle='dotted',label='CompanyB',marker='<')

a=np.array([25,60,5,10,])
labe=["AIML","Python","Pandas","Numpy"]
colors=['blue','black','yellow','Crimson']
...
fontsize=15
explo=[0.2,0,0,0]
plt.pie(a,labels=labe,explode=explo,colors=colors,startangle=360,textprops={'fontsize':fontsize},shadow='true')
plt.show()
...
sns.heatmap(correlation_matrix,annot=True,cmap="coolwarm")
plt.title("Correlation heatmap of diamonds data set")
plt.show()
